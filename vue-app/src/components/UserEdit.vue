        ...
        <div class="row">
            <div class="col">
                ...
                <form-tag @userEditEvent="submitHandler" name="userform" event="userEditEvent">
                    ...
                    <div class="float-end">
                        <a v-if="(this.$route.params.userId > 0) && (parseInt(String(this.$route.params.userId), 10) !== store.user.id)" class="btn btn-danger" href="javascript:void(0);" @click="confirmDelete(this.user.id)">Delete</a>
                    </div>
